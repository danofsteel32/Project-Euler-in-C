 ...
 * I used vim to transform the 01,02,...,09 into actual ints for the grid and format 
 * it into an array in about 30 seconds. Vim is awesome. 
 * Runs in .002s */
...
{
    int i, j; // array[i][j]
    int greatest_product = 0, product;
